...
export default function Navbar() {
  ...
  function myFunction() {
    ...
    var link = document.getElementById('linkFirst')
    console.log(x);
    if (x.className === "topnav") {
      x.className += " responsive";
      link.id += 'First'
    } else {
      var link = document.getElementById('linkFirstFirst')
      x.className = "topnav";
      link.id = 'linkFirst'
    }
  }
  ...
  <div className="topnav" id="myTopnav">
    <div className='navbar'>
      <Link id='linkFirst' className='link linkFirst' to="/"><img src='/adaptiv/mainPage640/logo_m 3.png' alt='logo' /> </Link>
